...
int change_player_velocity(player_t * player, uint8_t scancode){
  ...
  switch(scancode){
    case W_MAKE_CODE:  if(w_pressed) break;
                       ...
                       w_pressed = true;
                       break;
    case W_BREAK_CODE: if(w_pressed) player->y_velocity+=5; 
                       w_pressed = false;
                       break;
    case A_MAKE_CODE:  if(a_pressed) break;
                       ...
                       a_pressed = true;
                       break;
    case A_BREAK_CODE: if(a_pressed) player->x_velocity+=5; 
                       a_pressed = false;
                       break;
    case S_MAKE_CODE:  if(s_pressed) break;
                       ...
                       s_pressed = true;
                       break;
    case S_BREAK_CODE: if(s_pressed) player->y_velocity-=5; 
                       s_pressed = false;
                       break;
    case D_MAKE_CODE:  if(d_pressed) break;
                       ...
                       d_pressed = true;
                       break;
    case D_BREAK_CODE: if(d_pressed) player->x_velocity-=5; 
                       d_pressed = false;
                       break;
    default: return 1;
  }
